...
public class AboutScreen extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        drawString(g, "Space Invader Controls", new Rectangle(0, 0, AsteroidsGame.SCREEN_WIDTH, 64), 36);
        g.drawString("Move Left", 1 * AsteroidsGame.SCREEN_WIDTH / 6, 96 + 0 * 32);
        g.drawString("left arrow", 4 * AsteroidsGame.SCREEN_WIDTH / 6, 96 + 0 * 32);
        g.drawString("Move Right", 1 * AsteroidsGame.SCREEN_WIDTH / 6, 96 + 1 * 32);
